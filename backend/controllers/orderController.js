...
const newOrder = new orderModel(orderdData)
await newOrder.save()
...
const placeOrderStripe = async (req, res) => {
    try {
        ...
        // Ensure the total amount is sufficient
        const totalAmount = amount + delivery_charge;
        if (totalAmount < 0.3) { // 0.3 GBP = 30 pence
            throw new Error("The total amount must be at least 30 pence.");
        }
